...
| Version | Supported |
| --- | --- |
| 0.1.0-beta.23 (prepared; not yet published) | Pending publication |
| 0.1.0-beta.21 (`candidate` at preparation) | Yes |
| 0.1.0-beta.19 | No |
| 0.1.0-beta.18 | No |
| 0.1.0-beta.17 | No |
...
The candidate launcher uses the credential-free schema-3 manifest and pins every platform
